...
2. run `docker compose up -d --build` to start the container
3. run `docker ps` to see the container
4. run `docker exec -it chathackers_uk bash` to open the container